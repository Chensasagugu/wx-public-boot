...
import com.chen.annotation.FieldDescription;
import com.chen.exception.WxErrorCode;
...
public class Result<T> {
     ...
     * @return 错误返回值
     */
    public static <T> Result<T> fail(WxErrorCode code) {
     ...
     * @return 错误返回值
     */
    public static <T> Result<T> fail(WxErrorCode code, Object... args) {
     ...
     * @return 错误返回值
     */
    public static <T> Result<T> failWithData(WxErrorCode error, T data) {
